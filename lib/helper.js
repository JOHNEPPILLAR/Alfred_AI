...
async function callAlfredServicePut(apiURL, body) {
  ...
  try {
    ...
    log('error', 'callAlfredServicePut', `Error calling: ${apiURL}`);
...
async function callAlfredServiceGet(apiURL) {
  ...
  try {
    ...
    log('error', 'callAlfredServiceGet', `Error calling: ${apiURL}`);
...
async function callAPIService(apiURL, body) {
  ...
  try {
    ...
    log('error', 'callAPIService', `Error calling: ${err.message}`);
