...
const APIIOSDevices = require('../api/iosDevices/iosDevices.js');
const APICommute = require('../api/commute/commute.js');
const APIIOT = require('../api/iot/iot.js');
...
async function setupAndRun() {
  ...
  APIIOSDevices.applyRoutes(server);
  APICommute.skill.applyRoutes(server);
  APIIOT.applyRoutes(server);
  APILights.applyRoutes(server);
  APISchedules.applyRoutes(server);
  APISensors.applyRoutes(server);
  APIWeather.skill.applyRoutes(server, '/weather');
